...
This module requires an AI provider module integrated with Drupal’s plugin
 system. Drupal 10 or later is required.
...
## Usage
  ...
  Access the web interface via Reports > AI Log Analysis to view analyzed log
